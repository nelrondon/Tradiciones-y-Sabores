...
export default function OrdersView() {
    ...
    const filtradas = ordenes
        ...
        .filter((o) => {
            ...
            const cedula = (o.cliente_cedula || o.cedula_cliente || "")
                .toLowerCase()
                .replace(/[^0-9a-z]/g, "");
            const telf = (o.cliente_telefono || "")
                .toLowerCase()
                .replace(/[^0-9a-z]/g, "");
            return (
                ticket.includes(q) ||
    ...
    const conteo = (e: EstatusOrden) =>
        ordenes.filter((o) => o.Estatus_Orden === e).length;
    ...
    const cancelarOrden = async (orden: Orden) => {
        ...
        try {
            ...
            setOrdenes((prev) =>
                prev.filter((o) => o.id_pedido !== orden.id_pedido),
            );
            showToast(
                "success",
                `Pedido #${orden.id_pedido} cancelado`,
    ...
    return (
        <div className="p-8 flex-1 flex flex-col gap-6 max-w-[1200px] mx-auto w-full">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                {(["Recibido", "Preparando", "Listo"] as EstatusOrden[]).map(
                    (e) => {
            ...
            <div className="flex flex-col gap-2">
                {loading ? (
                    <div className="flex items-center justify-center py-16 text-on-surface-variant gap-3">
                        <Loader2 size={28} className="animate-spin" /> Cargando
                        pedidos...
                    </div>
                ) : filtradas.length === 0 ? (
                        ...
                        return (
                            ...
                            >
                                ...
                                <button
                                    ...
                                    onClick={() =>
                                        toggleExpandida(orden.id_pedido)
                                    }
                                >
                                            ...
                                            <table className="w-full text-sm min-w-[500px]">
                                                <thead>
                                                    <tr className="text-xs text-on-surface-variant uppercase border-b border-outline-variant">
                                                        ...
                                                        <th className="text-center pb-2 w-16">
                                                            Cant.
                                                        </th>
